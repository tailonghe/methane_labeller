...
class Application(tk.Tk):
    ...
    def do_search(self):
        ...
        if success is True: # 
            ...
            img_id_list, date_list, img_date_list, imgchannels, imgxch4, imglons, imglats = get_plume(self, self.lonnow, self.latnow, start_time.strftime('%Y-%m-%d'), end_time.strftime('%Y-%m-%d'), dX=0.01, dY=0.01, do_retrieval=False, satellite=current_sate)  # 5.905613686710645, 31.65857047520231  # 31.6585, 5.9053  # self.satenow.get()
            img_idx = 0
